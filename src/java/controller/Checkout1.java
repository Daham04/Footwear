...
public class Checkout1 extends HttpServlet {
    ...
    private void saveOrders(Session session, Transaction transaction, User user, Address address, JsonObject responseJsonObject) {
        try {
            ...
            String merchantSecretMdHash = Payhere1.generateMD5(merchantSecret);
            ...
            String md5Hash = Payhere1.generateMD5(merchant_id + order_id + formatted_amount + currency + merchantSecretMdHash);
